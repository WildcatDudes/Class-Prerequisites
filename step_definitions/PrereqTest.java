...
Prereq prereq = new Prereq();
	...
	@Then("^number of students in \"(.*?)\" courses is (\\d+)$")
	public void numberOfStudentsInCoursesIs(String arg1, int arg2) throws Throwable {
	    assertEquals(prereq.getCourseStudents(arg1), arg2);
	}
